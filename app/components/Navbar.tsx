    ...
    return (
        <header className='mb-8 bg-[#f1f1f1]'>
            <div className='flex items-center justify-between mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl'>
                ...
                <nav className={`gap-12 lg:flex backdrop-blur-xl md:backdrop-blur-lg sm:px-12 px-4 items-center justify-between lg:pb-0 z-50 absolute lg:static lg:z-auto left-0 w-full lg:w-auto lg:pl-0 transition-all duration-500 ease-in top-[73px] ${navbar ? 'right-0' : 'left-[100%]'}`}  >
